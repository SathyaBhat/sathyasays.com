...
<p style="width: auto; margin-top: 20px" align="center">
  <a href="https://www.kde.org/announcements/4.0/screenshots/desktop.jpg"><img src="https://www.kde.org/announcements/4.0/screenshots/desktop_thumb.jpg" align="middle"  /></a><br /> <em>The KDE 4.0 desktop</em>
</p>
...
Lots of KDE **Applications** have seen improvements as well. Visual updates through vector-based artwork, changes in the underlying libraries, user interface enhancements, new features, even new applications &#8212; you name it, KDE 4.0 has it. Okular, the new document viewer and Dolphin, the new file manager are only two applications that leverage KDE 4.0&#8217;s new technologies.
 ...
 <img src="https://www.kde.org/announcements/4.0/images/oxybann.png" align="right" hspace="5" />The Oxygen **Artwork** team provides a breath of fresh air on the desktop. Nearly all the user-visible parts of the KDE desktop and applications have been given a facelift. Beauty and consistency are two of the basic concepts behind Oxygen.
...
<p style="width: auto; margin-top: 20px" align="center">
  <a href="https://www.kde.org/announcements/4.0/screenshots/dolphin-systemsettings-kickoff.jpg"><img src="https://www.kde.org/announcements/4.0/screenshots/dolphin-systemsettings-kickoff_thumb.jpg" align="middle"  /></a><br /> <em>Filemanager, System Settings and Menu in action</em>
</p>
...
The following distributions have notified us of the availability of packages or Live CDs for KDE 4.0:
  ...
  * **Gentoo Linux** provides KDE 4.0 builds on [https://kde.gentoo.org][13].
...
Technorati Tags: <a href="https://technorati.com/tag/opensource" class="performancingtags" rel="tag">opensource</a>, <a href="https://technorati.com/tag/linux" class="performancingtags" rel="tag">linux</a>, <a href="https://technorati.com/tag/KDE4.0" class="performancingtags" rel="tag">KDE4.0</a>, <a href="https://technorati.com/tag/desktop%20environments" class="performancingtags" rel="tag">desktop environments</a>

 [1]: https://www.kde.org/announcements/4.0/
 [2]: https://www.kde.org/announcements/4.0/guide.php
 [3]: https://openusability.org/
 [4]: https://www.kde.org/announcements/4.0/education.php
 [5]: https://www.kde.org/announcements/4.0/applications.php
 [6]: https://techbase.kde.org/
 [7]: https://www.kde.org/announcements/4.0/desktop.php
 [8]: https://www.kde.org/announcements/4.0/games.php
 [9]: https://www.kde.org/info/4.0.php
 [10]: https://pkg-kde.alioth.debian.org/
 [11]: https://fedoraproject.org/wiki/Releases/9
 [12]: https://fedoraproject.org/wiki/Releases/Rawhide
 [13]: https://kde.gentoo.org/
 [14]: https://kubuntu.org/announcements/kde-4.0.php
 [15]: https://download.kde.org/binarydownload.html?url=/stable/4.0.0/Mandriva/
 [16]: https://en.opensuse.org/KDE/KDE4
 [17]: https://download.opensuse.org/repositories/KDE:/KDE4/openSUSE_10.3/KDE4-BASIS.ymp
 [18]: https://download.opensuse.org/repositories/KDE:/KDE4/openSUSE_Factory/KDE4-BASIS.ymp
 [19]: https://home.kde.org/%7Ebinner/kde-four-live/
